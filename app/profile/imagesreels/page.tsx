      ...
      <div className="w-full max-w-6xl">
       ...
       <div className="flex items-center gap-4 flex-wrap">
        ...
        <div className="flex justify-between mt-12">
          ...
          <button onClick={() => router.back()} className="flex items-center gap-2 bg-[#081f55] border-x border-yellow-400 px-8 py-3 rounded-lg">
            Previous
          </button>
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          ...
          <div className="bg-[#081f55] p-10 rounded-2xl text-center shadow-2xl">
            ...
            <p className="text-gray-300 mb-6">
              Your football profile has been successfully submitted
            </p>
...
function VideoCard({ video, setVideo }) {
  return (
    <div
      onClick={() => setVideo(video)}
      className="w-32 h-20 rounded-lg overflow-hidden cursor-pointer bg-black"
    >
